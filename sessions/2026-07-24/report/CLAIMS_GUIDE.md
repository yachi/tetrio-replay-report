...
- Match wins: pinglamb 4, yachi 3. Round wins: pinglamb 29, yachi 21. Total rounds 50. 7 matches, all first-to-5.
- Decider (5-4): m7 (yachi). Sweeps (5-0): m1 and m4, both pinglamb.
- Match winners in order 1..7: pinglamb, yachi, pinglamb, pinglamb, pinglamb, yachi, yachi.
