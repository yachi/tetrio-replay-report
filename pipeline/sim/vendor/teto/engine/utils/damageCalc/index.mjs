...
export const garbageCalcV2 = (data, config)=>{
    let garbage = 0;
    const { spin: rawSpin, lines, piece, combo, b2b, enemies } = data;
    const { spinBonuses, comboTable, garbageTargetBonus, b2b: b2bOptions } = config;
    ...
    if (combo > 0) {
        if (comboTable === "multiplier") {
            ...
            const comboTableData = garbageData.comboTable[comboTable] || [
                0
            ];
